/**
 * @file bignum_abs_benchmark_adapter.h
 * @brief Benchmark-framework adapter contract for bignum_abs.
 ...
 * @version 1.0.0
 */
#ifndef BIGNUM_ABS_BENCHMARK_ADAPTER_H
#define BIGNUM_ABS_BENCHMARK_ADAPTER_H
...
typedef enum bignum_abs_benchmark_status {
    BIGNUM_ABS_BENCHMARK_STATUS_SUCCESS = 0, /**< Adapter action succeeded. */
    BIGNUM_ABS_BENCHMARK_STATUS_NULL_ARGUMENT = 1, /**< A required pointer was NULL. */
    BIGNUM_ABS_BENCHMARK_STATUS_INVALID_PROFILE = 2 /**< A workload token was unsupported. */
} bignum_abs_benchmark_status_t;

/**
 * @brief Initializes the generic framework callbacks for absolute-value normalization.
 ...
 */
bignum_abs_benchmark_status_t bignum_abs_benchmark_adapter_init(
...
#endif /* BIGNUM_ABS_BENCHMARK_ADAPTER_H */
